...
define('EMAIL_FROM', 'appointments@smilebrightdental.sg');
define('EMAIL_FROM_NAME', 'Smile Bright Dental');
define('EMAIL_REPLY_TO', 'reception@smilebrightdental.sg');
define('EMAIL_SUPPORT', 'reception@smilebrightdental.sg');
...
define('SUPPORT_EMAIL', 'reception@smilebrightdental.sg');
